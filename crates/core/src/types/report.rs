...
pub struct AnalysisReport<L: Language> {
    ...
    ///
    /// Opaque to core — contains SD pipeline results, hierarchy data,
    /// and any other language-specific analysis output.
    #[serde(default)]
...
pub struct AnalysisResult<L: Language> {
    ...
    /// Language-specific analysis extensions.
    ///
    /// Opaque to core — produced by `Language::run_extended_analysis()`,
    /// consumed by `Language::build_report()`. Core passes this through
